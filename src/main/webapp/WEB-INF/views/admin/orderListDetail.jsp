		...
		<div id="header" class="">
			<div class="header_top">
				...
				<div class="inner">
					<div id="gnb">
						<ul>
							<li><a href="#juno" onclick="location.href='/junohair'">JUNO HAIR</a></li>
							...
							<li class="active"><a href="#juno" onclick="gotoMyjuno()">MY JUNO</a></li>
						</ul>
					</div>
				</div>
				<div class="util">
			...
			<div class="header_btm">
				<div class="inner">
					<h1>
						<a href="#juno" onclick="location.href='/junohair'">
								...
								<table border="1" cellpadding="0" cellspacing="0" summary="주문배송리스트">
								    ...
								    <c:forEach var="detail" items="${detail}">
								        <tr><!-- 
								            ...
								            <td>${detail.price}</td>
								            <td><img src="./resources/productupload/${detail.productImg1}" alt="Product Image" width="200" height="150"/></td>
								        </tr>
								    </c:forEach>
								    </tbody>
								</table>
